...
const CrewChoice: React.FC<ModalProps> = ({ show, onHide, expedition, drivers, userData }) => {
    ...
    return (
        <div>
            ...
            {/*Модальное окно для создания собственного экипажа*/}
            {showNew &&
            ...
            {/*Модальное окно для выбора экипажа, где есть свободные места для пассажиров*/}
            {showJoinCrew &&
